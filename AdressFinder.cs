...
namespace AddressFinder {
    ...
    public partial class AdressFinder : Form {
        #region "FORM_LOAD"
        ...
        private void Form2_Load(object sender, EventArgs e) {
            try {
                ...
                AddressFinder.Navigate("http://118.67.142.129/index.html");
                AddressFinder.ObjectForScripting = this;
        ...
        private void wb_size() {
            try {
                ...
                w = AddressFinder.Width;
                h = AddressFinder.Height;
            ...
            try {
                ...
                try {
                    ...
                    if (dr["userSelectedType"].Equals("R")) {
                        ...
                        if (!dr["buildingName"].Equals("") && dr["apartment"].Equals("Y")) { // 건물명이 있고, 공동주택일 경우 추가한다.
        ...
        private void lfn_Cshap_WEB_initLayerPosition(int w, int h) {
            AddressFinder.Document.InvokeScript("initLayerPosition", new object[] { w, h }); //웹 자바스크립트에전달
        }
        ...
        private void lfn_Cshap_WEB_Script2() {
            ...
            AddressFinder.Document.InvokeScript("Cshap_WEB_Script2", new object[] { str1, str2 }); //웹 자바스크립트에전달
